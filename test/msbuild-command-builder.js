...
describe('msbuild-command-builder', function () {
  ...
  describe('buildArguments', function () {
    it('should build arguments with default options', function () {
      ...
      expect(result).deep.equal(['"/target:Rebuild"', '/verbosity:normal', '/toolsversion:4.0', '/nologo', '/maxcpucount', '/property:Configuration="Release"']);
    });
    ...
    it('should build arguments without nologo', function () {
      ...
      expect(result).deep.equal(['"/target:Rebuild"', '/verbosity:normal', '/toolsversion:4.0', '/maxcpucount', '/property:Configuration="Release"']);
    });
    ...
    it('should build arguments with positive maxcpucount', function () {
      ...
      expect(result).deep.equal(['"/target:Rebuild"', '/verbosity:normal', '/toolsversion:4.0', '/nologo', '/maxcpucount:4', '/property:Configuration="Release"']);
    });
    ...
    it('should build arguments with negative maxcpucount', function () {
      ...
      expect(result).deep.equal(['"/target:Rebuild"', '/verbosity:normal', '/toolsversion:4.0', '/nologo', '/property:Configuration="Release"']);
    });
    ...
    it('should build arguments with custom properties', function () {
      ...
      expect(result).deep.equal(['"/target:Rebuild"', '/verbosity:normal', '/toolsversion:4.0', '/nologo', '/maxcpucount', '/property:Configuration="Release"', '/property:WarningLevel="2"']);
    });
    ...
    it('should add Configuration Property when Configuration-Option is specified', function () {
      ...
      expect(result).deep.equal(['"/target:Rebuild"', '/verbosity:normal', '/toolsversion:4.0', '/nologo', '/maxcpucount', '/property:Configuration="Debug"']);
    });
    ...
    it('should use fileLoggerParameters when specified', function () {
      ...
      expect(result).deep.equal(['"/target:Rebuild"', '/verbosity:normal', '/toolsversion:4.0', '/nologo', '/flp:LogFile=Build.log', '/maxcpucount', '/property:Configuration="Release"']);
    });
    ...
    it('should use consoleLoggerParameters when specified', function () {
      ...
      expect(result).deep.equal(['"/target:Rebuild"', '/verbosity:normal', '/toolsversion:4.0', '/nologo', '/clp:Verbosity=minimal', '/maxcpucount', '/property:Configuration="Release"']);
    });
  });
  ...
  describe('construct', function () {
    ...
    it('should construct a valid command', function () {
      ...
      expect(command.executable).to.be.equal('"here"');
      expect(command.filePath).to.equal('"test.sln"');
      expect(command.args.length).to.equal(6);
    });
  });
